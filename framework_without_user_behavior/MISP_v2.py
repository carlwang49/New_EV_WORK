'''
MISP 改版
initial threshold = (該cs k 6/16-6/30平均request) / (該cs k 當天分到的budget)
...
class MISP(base):
    ...
    def set_threshold(self, combinations, date):
        ...
        print(average_request_2_weeks_ago_df)
        ...
        for locationID in self.budget.index:
            ...
            print(locationID)
            request_count = average_request_2_weeks_ago_df[average_request_2_weeks_ago_df['locationId'] == locationID].shape[0]
            print(request_count)
