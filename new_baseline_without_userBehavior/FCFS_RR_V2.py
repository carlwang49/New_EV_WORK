...
TESTING_NAME = "FCFS_RR_V2_without_userBehavior"
TEST_DAY = "2023-06-28"
...
if __name__ == "__main__":
    ...
    for day in range(7):
        ...
        for requestID, userID, charging_len, origin_hour, origin_cs in charging_request:
            ...
            try:
                if model.FCFS_RR(slots_df, userID, charging_len):
                    round_csID, round_hour = model.FCFS_RR(slots_df, userID, charging_len)
                else:
