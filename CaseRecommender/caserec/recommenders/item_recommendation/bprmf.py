...
from CaseRecommender.caserec.recommenders.item_recommendation.base_item_recommendation import BaseItemRecommendation
from CaseRecommender.caserec.utils.extra_functions import timed
...
class BprMF(BaseItemRecommendation):
    ...
    def input_with_kg(self, kg_q):
        self.q = kg_q

    def output_with_kg(self):
        return self.q
