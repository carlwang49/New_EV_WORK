...
### global variable ###
ALPHA = 0.2
TESTING_NAME = "MISP_QLearn_Origin_newBehavior"
TEST_DAY = "2024-03-04"
...
PATH = f"../NewResult/Carl/{TESTING_NAME}/SIGMOID_INCENTIVE_UNIT_COST_{SIGMOID_INCENTIVE_UNIT_COST}/EPSILON_RATE_{EPSILON_RATE}/{TEST_DAY}/alpha_{ALPHA}/"
FILE_PATH = f'../NewResult/Carl/{TESTING_NAME}/SIGMOID_INCENTIVE_UNIT_COST_{SIGMOID_INCENTIVE_UNIT_COST}/EPSILON_RATE_{EPSILON_RATE}/{TEST_DAY}/q_table.json'
...
if __name__ == "__main__":
    ...
    for day in range(7):
        ...
        # path = f"../Result/Carl/MISP/{TESTING_NAME}/SIGMOID_INCENTIVE_UNIT_COST_{SIGMOID_INCENTIVE_UNIT_COST}/EPSILON_RATE_{EPSILON_RATE}/{TEST_DAY}/alpha_{ALPHA}/{random_counter}/"
        path = PATH
