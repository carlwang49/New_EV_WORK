...
### global variable ###
ALPHA = 0.2
TESTING_NAME = "MISP_incentive_025_cost_01_s025_emb_210"
TEST_DAY = "2023-07-14"
...
if __name__ == "__main__":
    ...
    for day in range(7):
        ...
        path = f"../Result/Carl/MISP/{TESTING_NAME}/SIGMOID_INCENTIVE_UNIT_COST_{SIGMOID_INCENTIVE_UNIT_COST}/DIM_{EMB_DIM}/{TEST_DAY}/alpha_{ALPHA}/"
    ...
    file_path = f'../Result/Carl/MISP/{TESTING_NAME}/SIGMOID_INCENTIVE_UNIT_COST_{SIGMOID_INCENTIVE_UNIT_COST}/DIM_{EMB_DIM}/{TEST_DAY}/q_table.json'
