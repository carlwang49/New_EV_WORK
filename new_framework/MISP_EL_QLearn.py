...
### global variable ###
ALPHA = 0.5
TESTING_NAME = "MISP_EL_QLearn_output"
TEST_DAY = "2023-07-06"
...
if __name__ == "__main__":
    ...
    file_path = f'../Result/Carl/MISP/{TESTING_NAME}/{TEST_DAY}/alpha_{ALPHA}/q_table.json'

    os.makedirs(os.path.dirname(file_path), exist_ok=True)
    with open(f'../Result/Carl/MISP/{TESTING_NAME}/{TEST_DAY}/alpha_{ALPHA}/q_table.json', 'w') as json_file:
