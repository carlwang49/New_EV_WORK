...
personal_willingness 是用 sigmoid
可用充電位=0 也可以算
'''
import os
import math
...
### global variable ###
ALPHA = 0.5
TESTING_NAME = "MISP_incentive_025_cost_01"
TEST_DAY = "2023-07-03"
...
class MISP(base):
    ...
    def calculate_utilization(self, slots_df=None, schedule=None, charging_len=0, first=False):
        ...
        # 即沒有考慮沒有充電樁可充的情況
        self.load_matrix[buildingID][hour:(hour+charging_len)] = numerator / np.where(condition, 1, denominator)
